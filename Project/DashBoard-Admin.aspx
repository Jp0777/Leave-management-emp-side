...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid row"  style="width: 75%; margin-left: 20%">
            ...
            <div class="card text-dark bg-light  col-5" style="margin:25px ;max-height:15rem" >
            ...
            <div class="card text-white bg-dark  col-5" style="margin:12px 25px;max-height:15rem">
