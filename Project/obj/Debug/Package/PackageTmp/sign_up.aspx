...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="  text-center container mt-5 " style="border: 2px solid whitesmoke; height: 720px;
                ...
                <div class="col-12 row">
                    ...
                    <div class="col-6 col-md-6 col-sm-12">
                        ...
                        <div class="mb-1">
                            ...
                            <br />
                            <br />
                            <asp:RadioButtonList ID="Gender" runat="server" Font-Size="Larger">
                ...
                <div class="mb-1 text-center">
                    <br />
                    <asp:Button ID="Submit" Class="btn btn-outline-primary btn-lg text-center" runat="server"
